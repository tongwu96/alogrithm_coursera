...
Offering by coursera.org

Week 1 Assignment - Counting Inversions
Input: text file This file contains all of the 100,000 integers between 1 and 100,000 (inclusive) in some order, with no integer repeated.
...
Input: test file The file contains all of the integers between 1 and 10,000 (inclusive, with no repeats) in unsorted order. The integer in the ith row of the file gives you the ith entry of an input array.
...
###Question 1 DIRECTIONS FOR THIS PROBLEM:
